    ...
    <div class="row justify-content-center">
        <div class="col-6">
            ...
            <form  method="POST" action="{{ route('admin.projects.show', $project) }}">
                ...
                <input class="form-control mb-4" type="text" placeholder="Website_url" aria-label="Website_url" name="website_url" id="website_url" value="{{ old('website_url', $project->website_url) }}">

                <input type="submit" class="btn btn-primary mb-3" value="Update {{ $project->title }}">
            </form>
        </div>
    </div>
</div>
